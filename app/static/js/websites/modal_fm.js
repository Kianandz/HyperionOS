...
async function loadFiles() {
    ...
    try {
        ...
        if (data.files.length === 0) {
            html += '<tr><td colspan="3" class="p-4 text-center text-slate-500">Folder is empty.</td></tr>';
        } else {
        ...
        listEl.innerHTML = '<tr><td colspan="3" class="p-4 text-center text-rose-500">Failed to load files.</td></tr>';
    }
}
